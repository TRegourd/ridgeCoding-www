...
function IndexHero({
  ...
  return (
    <section
      className="relative flex items-center bg-primary-600/5 py-36 dark:bg-primary-600/10 md:h-auto md:py-0"
      id="home"
    >
      <div className="container relative">
        <div className="mt-0 grid grid-cols-1 pt-0 text-center md:mt-12 md:pt-12">
          <div className="mt-28">
            <div>
